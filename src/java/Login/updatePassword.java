...
public class updatePassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(d.UpdatePassword(request.getParameter("TeacherID"),request.getParameter("Password"))){
              response.sendRedirect("adminpage.jsp?TeacherID"+request.getParameter("TeacherID"));
            }
